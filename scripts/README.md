...
**Scripts**: 
- [step5a_evaluate_cv_performance.R](https://github.com/statgenetics/TransCisPredict/blob/main/scripts/step5a_evaluate_cv_performance.R) - Evaluate cross-validation performance for four methods per protein
- [step5b_identify_best_method.R](https://github.com/statgenetics/TransCisPredict/blob/main/scripts/step5b_identify_best_method.R) - Select optimal method for each protein
- [step5c_summarize_all_methods.R](https://github.com/statgenetics/TransCisPredict/blob/main/scripts/step5c_summarize_all_methods.R) - Generate a comprehensive results summary for all proteins (optional), e.g., $CV-r$ and $CV-R^2$
...
**Scripts**:
- [step7a_predict_npx_population.R](https://github.com/statgenetics/TransCisPredict/blob/main/scripts/step7a_predict_npx_population.R) - Predict NPX residuals for each protein for every individual in the target sample
- [step7b_combine_npx_files.R](https://github.com/statgenetics/TransCisPredict/blob/main/scripts/step7b_combine_npx_files.R) - Combine all proteins predicted NPX residual levels into a single file
